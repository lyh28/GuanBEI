...
import com.lyh.guanbei.ui.activity.AddByMyselfActivity;
...
public class CustomNotificationManager {
    ...
    private static final String INPUT_DECORATION="方便用户快捷输入";
    public static NotificationCompat.Builder getInputNotification(Context context){
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            ...
            channel.setDescription(INPUT_DECORATION);
