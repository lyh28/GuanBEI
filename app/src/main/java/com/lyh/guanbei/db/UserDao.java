...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Local_book_id = new Property(8, String.class, "local_book_id", false, "LOCAL_BOOK_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"LOCAL_BOOK_ID\" TEXT);"); // 8: local_book_id
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        String local_book_id = entity.getLocal_book_id();
        if (local_book_id != null) {
            stmt.bindString(9, local_book_id);
        }
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8) // local_book_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setLocal_book_id(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
     }
