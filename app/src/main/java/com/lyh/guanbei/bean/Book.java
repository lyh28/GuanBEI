...
public class Book {
    ...
    @Generated(hash = 1929427095)
    public Book(Long local_id, @NotNull String book_name, long book_id, long manager_id, String person_id, String max_sum, String now_sum,
            int status) {
    ...
    public static List<Book> queryByUserId(Context context) {
        return query(BookDao.Properties.Book_id.in(Util.getLongFromData(CustomSharedPreferencesManager.getInstance(context).getUser().getBook_id())));
    }
