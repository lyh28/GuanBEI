...
public class NetRestartService extends IntentService{
    ...
    protected void onHandleIntent( Intent intent) {
        //Book表操作
        //取出需要提交到服务器的
        List<BookBean> insertBook=BookBean.query(BookBeanDao.Properties.Commit.eq(false));
        ...
        //取出需要更新到服务器的
        List<BookBean> updateBook=BookBean.query(BookBeanDao.Properties.Change.eq(true));
        ...
        //Record表操作
        //取出需要提交到服务器的
        List<RecordBean> commitRecord=RecordBean.query(RecordBeanDao.Properties.Commit.eq(false));
        ...
        //取出需要更新到服务器的
        List<RecordBean> updateRecord=RecordBean.query(RecordBeanDao.Properties.Change.eq(true));
